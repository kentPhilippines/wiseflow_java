...
public class NewsController {
    ...
    public ResponseEntity<IPage<News>> getNewsByCategory(
        ...
        Page<News> pageRequest = new Page<>(page + 1, size);
        IPage<News> newsPage = newsService.findByCategoryId(categoryId, pageRequest, domainConfig);
        return ResponseEntity.ok(newsPage);
    }
    ...
    public ResponseEntity<List<News>> getHotNews(
        ...
        Page<News> pageRequest = new Page<>(page + 1, size);
        List<News> newsList = newsService.findHotNews(pageRequest, domainConfig);
    ...
    public ResponseEntity<IPage<News>> getRecommendNews(
        ...
        Page<News> pageRequest = new Page<>(page + 1, size);
        IPage<News> newsPage = newsService.findRecommendNews(pageRequest, domainConfig);
        return ResponseEntity.ok(newsPage);
    }
    ...
    public ResponseEntity<List<News>> getTopNews(
        ...
        List<News> topNews = newsService.findTopNews(domainConfig);
    ...
    public ResponseEntity<IPage<News>> searchNews(
        ...
        Page<News> pageRequest = new Page<>(page + 1, size);
        IPage<News> newsPage = newsService.search(title, categoryId, startDate, endDate, pageRequest, domainConfig);
        return ResponseEntity.ok(newsPage);
    }
    ...
    public ResponseEntity<News> saveNews(@RequestBody News news) {
        ...
        return ResponseEntity.ok(newsService.save1(news));
    }
